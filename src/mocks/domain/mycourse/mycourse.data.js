export const promotionList = {
    getAllPromotion: [
        {
            id: "1",
            title: "노션으로 포트폴리오를 만들어보자",
            products: {
                id: "1",
                thumbnailUrl: "/image/demo_slideBanner_img.png",
                discountPrice: 20000,
                discountPercent: 10,
                subDescription:
...
export const getTodoBestPracticeByProductIdOutput = {
    getProductById: {
        creator: {
            name: "botoo",
            job: "보고서 전문가",
            ...
            },
            {
                ...
                todos: [
                    ...
                    },
                    {
                        ...
                        title: "데이터 창고 활용하기",
                        bestPracticeImageUrl: "/image/demo_main_01_1.png",
                    },
                    {
